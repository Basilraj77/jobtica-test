-- Migration: create_content_versions
-- Created at: 1762112347
...
CREATE INDEX IF NOT EXISTS idx_content_versions_is_published ON content_versions(is_published_version);

-- Composite index for efficient version lookup
DROP INDEX IF EXISTS idx_content_versions_unique_version;
...
-- Create policies
DROP POLICY IF EXISTS "Admin users can manage all content versions" ON content_versions;
...
DROP POLICY IF EXISTS "Users can view their own content versions" ON content_versions;
